...
for i in range(1, nsteps):
    polygon_star(canvas, i * step_x, i * step_y, p, t, outline='red', fill='gold', width=3)
    polygon_star(canvas, i * step_x, canvas_height - i * step_y, p, t, outline='red', fill='gold', width=3)
